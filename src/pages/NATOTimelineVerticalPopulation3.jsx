...
const VISIBLE_COUNT = 3; // Number of visible members in the feed (changed from 5 to 3)
...
function NATOTimelineVerticalPopulation3() {
  ...
  // Show last 3 members in the feed
  const displayMembers = useMemo(() => {
    // Always show last 3 (or fewer if less available)
    ...
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.content}>
          {/* Left: Member List - exactly 3 items, fade in at bottom, fade out at top */}
...
export default NATOTimelineVerticalPopulation3;
